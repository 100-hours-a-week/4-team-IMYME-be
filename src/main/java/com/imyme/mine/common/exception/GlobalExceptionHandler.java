...
/** 전역 예외 처리 핸들러 - 모든 예외를 ErrorResponse 형식으로 변환 - 에러 로그 기록 */
@Slf4j
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(
    ...
    ErrorResponse response =
        ErrorResponse.of(ErrorCode.VALIDATION_FAILED, request.getRequestURI(), details);
  ...
  public ResponseEntity<ErrorResponse> handleConstraintViolationException(
    ...
    ErrorResponse response =
        ErrorResponse.of(ErrorCode.VALIDATION_FAILED, request.getRequestURI(), e.getMessage());
  ...
  public ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatchException(
    ...
    ErrorResponse response =
        ErrorResponse.of(ErrorCode.INVALID_REQUEST, request.getRequestURI(), details);
  ...
  public ResponseEntity<ErrorResponse> handleHttpMessageNotReadableException(
    ...
    ErrorResponse response =
        ErrorResponse.of(ErrorCode.INVALID_REQUEST, request.getRequestURI(), "잘못된 JSON 형식입니다");
