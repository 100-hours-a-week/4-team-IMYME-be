 ...
 * <h3>동작 원리</h3>
 * <p>
 * Spring Data JPA는 Native Query의 AS 별칭과 인터페이스의 getter 이름을 매칭합니다.
 * </p>
 * 
 * <pre>{@code
...
public interface KnowledgeSearchResult {
     ...
     * 벡터 임베딩 (1024차원)
     * <p>
     * 성능 고려: 필요 없으면 쿼리에서 제외 가능 (데이터가 커서 조회 성능 영향)
     * </p>
     */
    String getEmbedding();
     ...
     * </ul>
     * <p>
     * <b>주의:</b> 값이 작을수록 유사하므로, ORDER BY distance ASC로 정렬해야 합니다.
     * </p>
     */
    Double getDistance();
}
